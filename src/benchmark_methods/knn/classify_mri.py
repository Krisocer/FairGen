...
def sample_by_gender_proportion(gender_disease_dict, num, gender_proportions):
    ...
    gender_num_samples = {gender: int(num * gender_proportions[gender] / total_proportion)
...
# Argument Parser
# -----------------------------
parser = argparse.ArgumentParser(description="KNN MRI Fairness Classification")
    ...
    for num in range(100, 900, 100):
        for idx, proportions in enumerate(proportion_list):
            ...
            if args.aug_data:
                ...
                selected_indices = sample_by_gender_proportion(gender_disease_dict, num * 4, gender_proportions)
