...
class DualLabelDataset(Dataset):
    def __init__(self, root, transform=None):
        ...
        self.race_labels = {0: 'African', 1: 'Asian', 2: 'Caucasian'}
...
for seed in range(3,7,1):
    ...
    for num in range(500,1000,100):
        ...
        for epoch in range(args.epochs):
            ...
            if epoch == 0:
                class_weights = torch.ones(3)  # Assuming 3 races
            else:
        ...
        if args.best_worst:
            ...
            if epoch_5_model_state is not None:
                epoch_5_model_name = f"skin_epoch5_seed{args.seed}_num{num}"
            ...
            if final_model_state is not None:
                final_model_name = f"skin_final_seed{args.seed}_num{num}"
